...
import com.tg.locationsystem.utils.CameraUtil.commandbuidler.CommandAssembly;
import com.tg.locationsystem.utils.CameraUtil.commandbuidler.CommandAssemblyImpl;
import com.tg.locationsystem.utils.CameraUtil.commandbuidler.CommandBuidler;
import com.tg.locationsystem.utils.CameraUtil.data.CommandTasker;
import com.tg.locationsystem.utils.CameraUtil.data.TaskDao;
import com.tg.locationsystem.utils.CameraUtil.data.TaskDaoImpl;
import com.tg.locationsystem.utils.CameraUtil.handler.*;
...
public class CommandManagerImpl implements CommandManager {
	...
	public String start(String id, String command, boolean hasPath) {
		...
		if (id != null && command != null) {
			System.out.println("配置命令="+command);
