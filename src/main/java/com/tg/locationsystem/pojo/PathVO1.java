 ...
 * @ Date2019/8/1
 */
public class PathVO1 implements Serializable {
    ...
    private List<TagHistoryVO> tagHistoryList;
    ...
    public List<TagHistoryVO> getTagHistoryList() {
        return tagHistoryList;
    }

    public void setTagHistoryList(List<TagHistoryVO> tagHistoryList) {
